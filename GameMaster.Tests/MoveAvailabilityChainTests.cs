...
namespace GameMaster.Tests
{
    public class MoveAvailabilityChainTests
    {
        ...
        {
            var l = new Shared.Board.Location() { X = 4, Y = 0 };
        ...
        {
            var l = new Shared.Board.Location() { X = 0, Y = 7 };
            var moveAvailabilityChain = new MoveAvailabilityChain(l, MoveType.Up, Team.Blue, board);
            Assert.False(moveAvailabilityChain.ActionAvailable());
        }
        ...
        public void BlueMovingDownToRedGoal()
        {
            ...
            var moveAvailabilityChain = new MoveAvailabilityChain(l, MoveType.Down, Team.Blue, board);
            Assert.False(moveAvailabilityChain.ActionAvailable());
        }
